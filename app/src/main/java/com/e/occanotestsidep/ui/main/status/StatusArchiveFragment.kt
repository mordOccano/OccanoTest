...
class StatusArchiveFragment : Fragment() ,AckStatusAdapter.Interaction, View.OnClickListener {
...
//            ItemTouchHelper(itemTouchHelperCallback).attachToRecyclerView(status_rv_acknowledge_notification)
            statusAckRVAdapter = AckStatusAdapter(this@StatusArchiveFragment)
...
////                deleteStatus(archiveListForRv[viewHolder.adapterPosition])
//            }
//        }

//    private fun deleteStatus(status: Status) {
//        archiveListForRv.remove(status)
//
        //update the
